...
public class ErrorMessageUtil {
  ...
  /**
   * Create a {@link org.springframework.http.ResponseEntity} with message.
   *
   * @param errorMessage Error message.
   * @return {@link org.springframework.http.ResponseEntity} with message.
   */
  ...
  /**
   * Create a {@link org.springframework.http.ResponseEntity} with message and HTTP status.
   *
   * @param errorMessage Error message.
   ...
   * @return {@link org.springframework.http.ResponseEntity} with message and status.
   */
  public static ResponseEntity<ErrorMessageDto> createResponse(final String errorMessage,
  ...
  /**
   * Wraps a created {@link ErrorMessageDto} in a {@link org.springframework.http.ResponseEntity}.
   *
